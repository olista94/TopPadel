...
<?php
 ...
 class Clases_Grupales_ADD_Tarjeta{	 
...
<!--Formulario para añadir socio-->
  <form name="Form" id="registerForm" action="../Controllers/Clases_Grupales_Controller.php" method="post" enctype="multipart/form-data" onsubmit="return comprobarTarjeta(this)">
